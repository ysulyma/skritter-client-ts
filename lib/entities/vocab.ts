...
export const Vocab = z
  .object({
    ...
    // (mutable)
    containedVocabIds: z.array(z.string()),

    // (mutable)
    customDefinition: z.string(),
    ...
    /**
     * {@link Vocab} id of the sentence for this word for this user.
     * If the user has not chosen a sentence, the most popular one is returned.
     * Returned only if `include_sentences` is true. */
    sentenceId: z.string(),
